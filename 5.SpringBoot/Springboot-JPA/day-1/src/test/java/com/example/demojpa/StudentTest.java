...
//        Page<Student> page1 = studentRepository.findAll(request1);
...
//        PageRequest request =PageRequest.of(0,10);
//        Page<Student> page = studentRepository.findByNameContainingIgnoreCase("m", request);
//        page.getContent().forEach(System.out::println);
//
//        PageRequest request1 =PageRequest.of(0,10);
//        Page<Student> page1 = studentRepository.findByNameContainingIgnoreCaseUsingNQ("m", request1);
//        page1.getContent().forEach(System.out::println);
//    }
//}
